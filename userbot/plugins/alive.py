...
async def amireallyalive(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"**{EMOJI} Kuserbot Version :** `{catversion}`\n"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} Kuserbot Version :** `{catversion}`\n"
...
async def amireallyalive(alive):
    ...
    reply_to_id = await reply_id(alive)
    cat_caption = f"**Kuserbot is Up and Running**\n"
    cat_caption += f"**  -Telethon version :** `{version.__version__}\n`"
    cat_caption += f"**  -Kuserbot Version :** `{catversion}`\n"
